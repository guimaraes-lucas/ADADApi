...
RSpec.describe '/disciplines', type: :request do
  ...
  # DisciplinesController, or in your router and rack
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get disciplines_url, headers: valid_headers, as: :json
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new Discipline' do
        expect do
          post disciplines_url,
               params: { discipline: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      it 'does not create a new Discipline' do
        expect do
          post disciplines_url,
               params: { discipline: invalid_attributes }, as: :json
        end.to change(Discipline, :count).by(0)
      end

      it 'renders a JSON response with errors for the new discipline' do
        post disciplines_url,
             params: { discipline: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested discipline' do
        discipline = Discipline.create! valid_attributes
        patch discipline_url(discipline),
              params: { discipline: invalid_attributes }, headers: valid_headers, as: :json
        discipline.reload
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested discipline' do
      discipline = Discipline.create! valid_attributes
      expect do
        delete discipline_url(discipline), headers: valid_headers, as: :json
      end.to change(Discipline, :count).by(-1)
    end
  end
end
